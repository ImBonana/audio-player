...
public class PlayCommands {
    ...
    @Command("play")
    public void play(CommandContext<ServerCommandSource> context, @Name("sound") UUID sound, @Name("location") Vec3d location, @Name("range") @Min("0") float range) throws CommandSyntaxException {
