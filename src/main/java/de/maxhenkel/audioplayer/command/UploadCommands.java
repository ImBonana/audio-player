        ...
        context.getSource().sendFeedback(() ->
                        Text.literal("Upload audio via Filebin ")
                                .append(Text.literal("here").styled(style -> style
                                        ...
                                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Text.literal("Click to show more")))).formatted(Formatting.GREEN))
                                .append(".")
                , false);
        context.getSource().sendFeedback(() ->
    ...
    public void url(CommandContext<ServerCommandSource> context) {
        context.getSource().sendFeedback(() ->
                        Text.literal("If you have a direct link to a ")
                                ...
                                .append(Text.literal("/audioplayer url <link-to-your-file>").formatted(Formatting.GRAY).styled(style -> style
    ...
    public void serverFile(CommandContext<ServerCommandSource> context) {
        context.getSource().sendFeedback(() ->
                        Text.literal("Upload a ")
                                ...
                                .append(Text.literal("/audioplayer serverfile \"yourfile.mp3\"").formatted(Formatting.GRAY).styled(style -> style
